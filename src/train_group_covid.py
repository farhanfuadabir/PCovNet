...
for idx in range(len(subject_info)):
    ...
    tl_vae_ckpt_path = join(os.pardir, "experiment", "trained_model_healthy_phase1_24_7",
                            "vae_checkpoint", "ckpt")
    vae_ckpt_path = join(
    ...
    # Assign checkpoint paths
    tl_lstm_ckpt_path = join(os.pardir, "experiment", "trained_model_healthy_phase1_24_7",
